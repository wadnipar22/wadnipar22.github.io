...
window.onload = function() {
    ...
    console.log(params.toString()); // Muestra todos los parámetros
...
function sendMessage() {
    ...
    if (message.trim() !== "") {
        // Crear un mensaje visible en la ventana del chat
        var chatMessages = document.getElementById("chatMessages");
        var userMessage = document.createElement("p");
        userMessage.textContent = "Tú: " + message;
        chatMessages.appendChild(userMessage);

        // Enviar el mensaje al servidor Flask mediante fetch
        fetch('https://10.88.0.4/api/chat', { // Cambia la URL si es necesario
    method: 'POST',
    headers: {
    ...
    body: JSON.stringify({ message: message })
        ...
        .then(data => {
            ...
            serverMessage.textContent = "Soporte: " + data.response;
